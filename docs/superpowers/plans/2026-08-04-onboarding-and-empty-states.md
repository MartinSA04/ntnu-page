...
- **Banned vocabulary:** **"tegne uka" is struck** — no `tegner vi uka`, `tegne uka di`, or any inflection, in UI copy or in new code comments. The replacement idiom is **"så er uka klar"**.
